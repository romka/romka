...
Недалеко от Рейкьявика есть похожее место --- Blue Lagoon, в общем случае оно, как и всё в той части острова, гораздо сильнее заполнено туристами, хотя во время моей поездки наоборот было закрыто, из-за риска извержения того самого вулкана. Поэтому, я бы отметил Myvatn Nature Baths как еще один рекомендованный пункт назначения (_о нет! Я ставлю галочки в чеклисте!!!_). Важно отметить, что мне повезло и большую часть времени в бассейнах было почти пусто, иногда я оставался там совсем один, но к моменту моего ухода сюда приехал автобус наполненный китайскими туристами, которые быстро превратили тихую лагуну в шумный суетливый беспорядок. 

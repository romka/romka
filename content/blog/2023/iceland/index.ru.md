...
В стране проживает около 300 тысяч человек и примерно 200 тысяч из них --- в Рейкьявике. То есть это совершенно точно то место, от которого стоит держаться подальше, так как ощущения уединённости это одна из тех целей, ради которых стоит ехать в Исландию.
...
На острове есть несколько крупных ледников в совершенно неземными (extraterrestrial) пейзажами, пещерами, реками и водопадами. Один из ледников использовался в качестве декораций для двух планет в фильме Интерстеллар (научно-фантастический фильм номер 1 за всю историю кино).
...
Для того чтобы без спешки попробовать всё что перечислено выше не хватит и месяца, поэтому чтобы не превратиться в чеклист-туриста пришлось заметно подсократить список. Итоговым для стал такой маршрут:
- прилетаю в Рейкьявик, он расположен на западе острова, и затем местными авиалиниями лечу в Акурейри, город на северо-востоке острова,
